            ...
            <>
                <div className="Entete">
                    <div className="Meta">
                        ...
                        <div className='metaInfo' onClick={openLink}>
                            <div>
                                Débute le 14 Déc
                            </div>
                ...
                <div className="Contenu"> 
                    ...
                    <div>
                        <p>
                            Pour tirer le meilleur de cette formation, vous devriez disposer les prérequis suivant :
                        </p>
                        <ul>
                            <li>
                                <span className='module'>Les bases en python</span>
                                <p>
                                    Python est le langage de programmation le plus utilisé en machine learning, vous 
                                    devriez disposer un base en python. Les notion suivant sont indispensable les sturctures de données
                                    la programmation orienté objet.
                                </p>
                                <span className='module'>L'algèbre</span>
                                <p>
                                    Vous aurez à manipuler les matrices et effectuer les opérations algébriques, il est très important
                                    de disposer des fondements dans ce domaine.
                                </p>
                            </li>
                        </ul>
                     </div>
