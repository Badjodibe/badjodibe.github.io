...
function Lstm(){
    return(
        ...
        <div className="article-container">
            <h2 className="title">LSTM application prédiction du prix d'instrument financier</h2>
            <section>
                <h3 id="definition" className="section-title">Introduction au deep Learning</h3>
                <hr />
                <p className="paragraphe">Le deep learning, ou apprentissage profond, est une catégorie 
            ...
            <section>
                <h3 id="application" className="section-title">Les réseaux de neuronne</h3>
                <hr />
            ...
            <section>
                <h3 id="lien" className="section-title">L'architecure des LSTM</h3>
                <hr />
                <p className="paragraphe">
            ...
            <section>
                <h3 id="lien" className="section-title">Application des LSTM</h3>
                <hr />
                <p className="paragraphe">
            ...
            <section>
                <h3 id="lien" className="section-title">
            ...
            <div>
                ...
                <div className="recommandation">
                    ...
                    <a href="#/blog/deepLearning" className="alien">Deep Learning</a>
                </div>
            </div>
        </div>
        </div>
